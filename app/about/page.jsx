      ...
      <AnimatedSection variant="fadeUp" className="ylh-page-hero">
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p className="ylh-page-sub">
            Young Legal House is a pioneering initiative dedicated to empowering law students across India by fostering a dynamic ecosystem of learning, collaboration, and professional developme[...]
            Serving as a unified platform for aspiring legal professionals, we bridge the gap between academic pursuits and career advancement through access to internships, training programmes,[...]
            Driven by a vision to cultivate an informed, connected, and progressive legal community, Young Legal House strives to nurture the next generation of legal minds by encouraging excell[...]
      ...
      <AnimatedSection variant="fadeUp" style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        >
          ...
          <p style={{ fontStyle: 'italic', lineHeight: 1.7, color: 'var(--grey-text)', marginBottom: '16px' }}>
            &ldquo;We created Young Legal House because the journey from a law student to a top-tier practitioner shouldn&apos;t be a solo endeavor. This platform is designed to bridge the gap b[...]
          </p>
